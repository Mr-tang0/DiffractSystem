...
#define EVENT_LicenseOK		  (CHAR)17
#define EVENT_LicenseSnErr	  (CHAR)18
#define EVENT_LicenseTypeErr  (CHAR)19
...
#define EVENT_NETWORKBUSY	  (CHAR)54
#define EVENT_ErrDDRFULL      (CHAR)98
...
#define FP_TYPE_2417		   (CHAR)31
#define FP_TYPE_3543ZB         (CHAR)32
#define FP_TYPE_2417Z          (CHAR)33
#define FP_TYPE_1313           (CHAR)34
#define FP_TYPE_C243           (CHAR)35
...
extern "C" {
	...
	COM_API BOOL COM_ImgSaveStart();
	COM_API BOOL COM_ImgSaveExit();
	COM_API BOOL COM_ImgSavedRead();
	...
	COM_API BOOL COM_ImgOverlayEnable(UCHAR on);
	...
	COM_API BOOL COM_SetXwin_us(UINT32 xwin_us);
	COM_API BOOL COM_GetXwin_us(UINT32* pxwin_us);
	...
	COM_API BOOL COM_SetDynamicFps(UINT32 fps100Set);
	COM_API BOOL COM_GetDynamicFps(UINT32* pfps100);
	COM_API BOOL COM_SetDyncParaEnd();
	...
	COM_API BOOL COM_SetSdkLogLevel(UCHAR sdklevel);
	COM_API BOOL COM_GetSdkLogLevel(UCHAR* psdklevel);
